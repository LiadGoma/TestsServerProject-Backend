...
const extractRespondentBody = (req) => {
    const respondent = {
        name: req.body.name,
...
const extractAnsweredTestBody = (req) => {
    const answeredTest = {
...
const extractAnsweredQuestionBody = (req) => {
...
module.exports = {
    extractTestBody,
    extractRespondentBody,
    extractQuestionBody,
    extractAnsweredTestBody,
    extractAnsweredQuestionBody
}